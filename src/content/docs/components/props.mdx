...
More details: <span class="custom-link">[Typing Component Props](/typescript/composition/#typing-component-props)</span> <sup>TS</sup>
...
If you want to pass all the properties of an object as props, you can use <span class="custom-link">[`v-bind`](/core-concepts/template/#dynamically-binding-multiple-attributes)</span> <span class="custom-link">[without an argument](/core-concepts/template/#attribute-bindings)</span> (`v-bind` instead of `:prop-name`). For example, given a `post` object:
