...
- <span class="custom-link">[Vue DevTools Extension](/scalling-up/tooling/#browser-devtools)</span> also provides a performance profiling feature.Profiling Options​
