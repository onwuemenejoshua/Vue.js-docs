...
* During development, we recommend relying on a good <span class="custom-link">[IDE setup](https://vuejs.org/guide/typescript/overview.html#ide-support)</span> for instant feedback on type errors.
...
* Vue CLI also provides TypeScript support, but is no longer recommended. See <span class="custom-link">[notes below](https://vuejs.org/guide/typescript/overview.html#note-on-vue-cli-and-ts-loader)</span>.
...
* <span class="custom-link">[TS with Composition API](https://vuejs.org/guide/typescript/composition-api)</span>
