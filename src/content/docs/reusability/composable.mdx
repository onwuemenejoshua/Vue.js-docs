...
the <span class="custom-link">[Reactivity Fundamentals](/essentials/reactivity/)</span> and <span class="custom-link">[Lifecycle Hooks](https://vuejs.org/guide/essentials/lifecycle.html)</span> chapters.
:::
